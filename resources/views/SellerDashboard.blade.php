        ...
        <aside class="w-64 p-4 bg-white shadow-lg rounded-lg mr-6 top-8 max-h-fit sticky md:block">
            ...
            <div class="mb-6">
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" name="price_range" value="500000-1000000" class="form-checkbox text-blue-600">
                        <span class="text-sm ml-2 text-gray-600">Rp 500,000 - Rp 1,000,000</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="price_range" value="1000000-1500000" class="form-checkbox text-blue-600">
                        <span class="text-sm ml-2 text-gray-600">Rp 1,000,000 - Rp 1,500,000</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="price_range" value="1500000-2000000" class="form-checkbox text-blue-600">
                        <span class="text-sm ml-2 text-gray-600">Rp 1,500,000 - Rp 2,000,000</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="price_range" value="2500000-3000000" class="form-checkbox text-blue-600">
                        <span class="text-sm ml-2 text-gray-600">Rp 2,500,000 - Rp 3,000,000</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="price_range" value="3000000-15000000" class="form-checkbox text-blue-600">
...
<script>
    document.getElementById('filterButton').addEventListener('click', function () {
        ...
        const categories = Array.from(document.querySelectorAll('input[name="categories"]:checked')).map(cb => cb.nextElementSibling.innerText.trim());
    
        
        const selectedPriceRanges = Array.from(document.querySelectorAll('input[name="price_range"]:checked')).map(cb => cb.value);
        ...
        .then(data => {
            ...
            if (data.products.length) {
                ...
                productGrid.innerHTML = '<p class="text-center text-gray-500 mt-10">No products match your filters.</p>';
            }
        })
