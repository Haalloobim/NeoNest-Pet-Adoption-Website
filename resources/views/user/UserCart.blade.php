...
<body class="bg-gray-50">
    ...
    <div class="max-w-5xl mx-auto p-4 space-y-4">
        @if ($cart)
            @foreach ($cart as $product)
                <div
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-700 font-medium mt-2">Rp {{ number_format($product->price, 0, ',', '.') }}
                        </p>
                    </div>
            ...
            @if (count($cart) > 0)
                <div
                    class="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-white rounded-lg shadow">
                    <div class="flex-1">
